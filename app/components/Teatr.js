          ...
          <div className={style.sliderContent}>
            <div className={style.w50}>
              ...
              <h1 className={style.title}>
                ...
                <span className={`${style.titlePart} ${style.light}`}>
                  Web-Studia 2025
                </span>
              </h1>
              ...
              <div className={style.reciept}>
                <article className={style.item}>
                  ...
                  <p className={style.text}>
                    ...
                    работу над версткой. Полностью довольна, надеюсь на
                    дальнейшее сотрудничество по развитию сайта)
                  </p>
                </article>
                <article className={style.item}>
                ...
                <article className={style.item}>
                  ...
                  <p className={style.text}>
                    Доброе утро, чекнул щас то что у тебя выходит, белая тема
                    тоже секс просто, цвета прям и стиль подобраны идеально
                  </p>
                </article>
                <article className={style.item}>
